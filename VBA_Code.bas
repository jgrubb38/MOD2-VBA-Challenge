...
Sub StockData():
    ...
    For Each ws In Worksheets
        ...
        'Define where summary table values write to
        ...
        LastRow = ws.Cells(Rows.Count, 9).End(xlUp).Row
            ...
            For i = 2 To FirstRow
                ...
                'Locate the Greatest Decrease value and write to column Q, row 3
                ...
                'Locate the Greatest Total Volumn and write to column Q, row 4
